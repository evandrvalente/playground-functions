...
Projeto realizado durante o curso de Desenvolvimento Web pela [Trybe](https://www.betrybe.com/). Para este projeto, desenvolvi funções seguindo os requisitos especificados para o correto comportamento de cada uma delas.
...
Todas as funções foram implementadas nos arquivos `challenges.js` e `challenges2.js`, conforme instruções recebidas através de requisitos que deveriam ser atendidos e aprovados em seus respectivos testes.

## Detalhamento dos requisitos

### 1 - Criar função usando o operador &&
...
### 2 - Criar função que calcula a área de um triângulo
...
### 3 - Criar função que divida a frase
...
### 4 - Criar função que use concatenação de strings
...
### 5 - Criar função que calcule a quantidade de pontos no futebol
...
### 6 - Criar função que calcule a repetição do maior número
...
### 7 - Criar função de Caça ao Rato
...
### 9 - Criar função que Codifique e Decodifique
...
### 10 - Criar função de Lista de Tecnologias
...
### 11 - Criar função de Número de Telefone
...
### 12 - Criar função de Condição de existência de um triângulo
...
### 13 - Criar função de boas vindas ao Bar da Trybe!
...
Desafios 1 a 9: challenges.js
Desafios 10 a 13: challenges2.js
